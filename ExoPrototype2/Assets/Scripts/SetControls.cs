...
public class SetControls : MonoBehaviour
{
    ...
    {
        player1Prefab.GetComponent<ShipMovement>().yawTorque = 1;
        player1Prefab.GetComponent<ShipMovement>().pitchTorque = 1;
        player2Prefab.GetComponent<ShipMovement>().yawTorque = 1;
        player2Prefab.GetComponent<ShipMovement>().pitchTorque = 1;
    }
